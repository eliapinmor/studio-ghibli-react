...
export default function useFilms() {
  ...
  const CACHE_KEY = "ghibli_films_v1"; // añade _v1 por si cambias el formato en unfuturo
  /**
  ...
  function reload() {
    ...
    localStorage.removeItem(CACHE_KEY);
    return fetchFromAPI();
    // Opción B (alternativa): pedir a la API y sobreescribir cache sin borrarantes.
  }
