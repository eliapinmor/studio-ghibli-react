  ...
  return (
    <section>
      ...
      <p style={{ marginTop: "1rem", color: "#666" }}>
        Aprendemos que <code>useState</code> guarda datos que sobreviven entre
        renders, y con <code>useEffect</code> reaccionamos a cambios para
        afectar al mundo exterior (como el título).
      </p>
    </section>
  );
}
